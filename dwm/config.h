...
/* tagging */
static const char *tags[] = { "один", "два", "три", "четыре" };
...
static Key keys[] = {
	...
	{ 0,				XF86XK_MonBrightnessUp,      spawn,	     SHCMD("light -A 10 && dunstbri") },
	{ 0,				XF86XK_MonBrightnessDown,    spawn, 	     SHCMD("light -U 10 && dunstbri")},
